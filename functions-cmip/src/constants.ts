...
export const accessToken = {
  metaInsightToken: defineSecret('META_INSIGHT_ACCESS_TOKEN'),
}

// 네이버 애드부스트/쇼핑부스트업/GFA 등 검색광고가 아닌 네이버 매체의 통합 캠페인 라벨.
// 요약형 파서와 per-row 파서가 반드시 같은 문자열을 써야 캠페인 목록에서 쪼개지지 않는다.
