...
export const PARKE_DOCS: AppDocs = {
  privacy: (
    <>
      ...
      <ul>
        ...
        <li>
          백신프로그램을 이용하여 컴퓨터 바이러스에 의한 피해를 방지하기 위한
          조치
        </li>
        <li>
          백신프로그램은 주기적으로 업데이트되며 갑작스런 바이러스가 출현할 경우
          백신이 나오는 즉시 이를 제공함으로써 개인정보가 침해되는 것을 방지
        </li>
      </ul>
      <p>2. 관리적 대책</p>
      <ul>
        <li>
          ...
          보호 의무 등에 관해 정기적인 사내 교육 실시.
        </li>
        <li>
          입사시 개인정보 관련 처리자의 보안서약서를 통하여 사람에 의한
          정보유출을 사전에 방지하고 개인정보보호정책에 대한 이행사항 및 직원의
          준수여부를 감사하기 위한 내부절차를 마련.
        </li>
        <li>
          개인정보 관련 처리자의 업무 인수인계는 보안이 유지된 상태에서 철저하게
          이뤄지고 있으며 입사 및 퇴사 후 개인정보 사고에 대한 책임을 명확화.
        </li>
        <li>
          개인정보와 일반 데이터를 혼합하여 보관하지 않고 별도로 분리하여 보관.
        </li>
      </ul>
      ...
      <ul>
        <li>성명: 강대렬</li>
        <li>연락처: daniel@originalshq.com</li>
      </ul>
  ...
  consent: (
    <>
      <p className="doc-intro">
        (주)오리지널스(이하 "회사")는{' '}
        <strong>「개인정보 보호법」 제15조제1항제1호</strong>에 따라 아래와 같이
  ...
  'consent-third': (
    <>
      <p className="doc-intro">
        (주)오리지널스(이하 "회사")는{' '}
        <strong>「개인정보 보호법」 제17조제1항제1호</strong>에 따라 아래와 같이
